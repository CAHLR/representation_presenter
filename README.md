...
The following command uses course subject as one factor to the multi-factor course2vec 
	...
	python representation_presenter.py -i your_data_path/enrollment_Broome_multi_c2v_input.csv,3 -g OSKI_ANON_ID -s T -k TERM_SUNY_CSID -r OSKI_COURSE_SUBJECT_SHORT_NM
